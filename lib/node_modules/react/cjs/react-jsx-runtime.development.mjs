"use client";
import { __exports as T } from "../../../_virtual/react-jsx-runtime.development.mjs";
...
function lr() {
  return Ee ? T : (Ee = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function xe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === C || e === K || ke || e === B || e === A || e === D || je || e === _e || we || Oe || Pe || typeof e == "object" && e !== null && (e.$$typeof === F || e.$$typeof === w || e.$$typeof === G || e.$$typeof === J || e.$$typeof === S || // This needs to include all possible module reference object
    ...
    function ze(e, r, t, n, o) {
      {
        ...
        t !== void 0 && (le(t), a = "" + t), Be(r) && (le(r.key), a = "" + r.key), Ne(r) && (c = r.ref, Ke(r, o));
        for (u in r)
    ...
    function ye(e, r, t, n, o, u) {
      {
        ...
        if (m.call(r, "key")) {
          var b = p(e), v = Object.keys(r).filter(function(ir) {
            return ir !== "key";
          }), N = v.length > 0 ? "{key: someKey, " + v.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!he[b + N]) {
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, N, b, ar, b), he[b + N] = !0;
          }
        }
